...
class HotlinesScreen extends StatelessWidget {
  ...
  static final List<Map<String, dynamic>> _hotlines = [
    // Emergency Services
    {'name': 'National Emergency Services', 'number': '911', 'icon': 'emergency', 'category': 'emergency'},
    {'name': 'Philippine Red Cross', 'number': '143', 'icon': 'health', 'category': 'emergency'},
    {
    ...
    },
    {
      ...
      'numbers': ['(036) 621-0221', '(036) 620-5618', '(036) 522-5211', '0950-608-5228'],
      'icon': 'fire',
      'category': 'emergency'
    },
    {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Emergency hotlines
          ..._hotlines.where((h) => h['category'] == 'emergency').map((hotline) {
          ...
          ..._hotlines.where((h) => h['category'] == 'government').map((hotline) {
            return _buildHotlineCard(context, hotline);
          }),
        ],
      ),
